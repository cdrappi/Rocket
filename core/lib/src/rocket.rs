...
fn hyper_service_fn(
    ...
    async move {
        ...
        let req_res = pair.as_mut().try_set_request(move |rocket| {
        ...
        match req_res {
            Ok(()) => {
                ...
                pair.as_mut().set_response(move |rocket, req|
